 ...
 */
public class InteractEntityContext extends InteractContext implements EntityContext {
    private final LivingEntity entity;

    public InteractEntityContext(@NotNull Player player, @NotNull Ability ability, @NotNull Action action, @NotNull EquipmentSlot hand, @NotNull LivingEntity entity) {
