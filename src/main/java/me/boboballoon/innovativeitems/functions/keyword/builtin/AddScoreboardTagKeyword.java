...
/**
 * Class that represents a keyword in an ability config file that adds a scoreboard tag to an entity
 */
public class AddScoreboardTagKeyword extends Keyword {
    public AddScoreboardTagKeyword() {
        super("addscoreboardtag",
