...
public class HealPercentKeyword extends Keyword {
    public HealPercentKeyword() {
        super("healpercent",
                ...
                new ExpectedValues(ExpectedValues.ExpectedPrimitives.DOUBLE, context -> LogUtil.log(LogUtil.Level.WARNING, "There is not a valid healing value entered on the " + context.getKeyword().getIdentifier() + " keyword on the " + context.getAbilityName() + " ability!")));
    }
